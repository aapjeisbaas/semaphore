...
A semaphore container with prepackaged galaxy roles and pip dependencies for those places where you have no or very limited internet access.


## currently inside this container

```shell
7403c7d6ca61:/home/semaphore# ansible-galaxy collection list
...
juniper.device                           1.0.3  
kubernetes.core                          3.0.1  
netbox.netbox                            3.17.0 
nutanix.ncp                              1.9.1  
servicenow.servicenow                    1.0.6  
7403c7d6ca61:/home/semaphore#
```